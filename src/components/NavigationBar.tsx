...
import LOGO from "../assets/query-logo.png";
            ...
            <li>
              <NavLink
                ...
                className={`block py-2 px-3 md:p-0 text-white bg-blue-700 rounded md:bg-transparent ${
                  pathname === "/products" ? "md:text-blue-500" : ""
            ...
            <li>
              <NavLink
                ...
                className={`block py-2 px-3 md:p-0 text-white rounded md:bg-transparent ${
                  pathname === "/get-products" ? "md:text-blue-500" : ""
                } md:hover:text-blue-700 `}
                aria-current="page"
              >
                GET products
